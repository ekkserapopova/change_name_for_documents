...
urlpatterns = [
    ...
    path(r'documents/', views.documents, name='documents-active-list'),
    path(r'documents/<int:pk>/', views.document, name='documents-detail'),
    path(r'documents/application/<int:pk>/', views.post_application, name='documents-post'),
    path(r'getuser/', views.get_user, name='get user'),
    
    path(r'applications/', views.get_applications, name='applications-list'),
    path(r'applications/<int:pk>/', views.application, name='application-detail'),
    ...
    path(r'applications/<int:pk>/mfc/', views.update_mfc, name='application-async'),
